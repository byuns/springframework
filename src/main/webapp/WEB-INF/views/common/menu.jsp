...
<ul class="nav flex-column">
	<li class="nav-item mb-2">
		<h6 class="text-white">
			<span class="m-2">Ch01.</span> 
			<a href="${pageContext.request.contextPath}/ch01/content" class="text-white">Development Environment</a>
		</h6>
	</li>
	<li class="nav-item mb-2">
		<h6 class="text-white">
			<span class="m-2">Ch02.</span> <a href="${pageContext.request.contextPath}/ch02/content" class="text-white">
	...
	<li class="nav-item mb-2">
		<h6 class="text-white">
			<span class="m-2">Ch03.</span> <a href="${pageContext.request.contextPath}/ch03/content" class="text-white">
	...
	<li class="nav-item mb-2">
		<h6 class="text-white">
			<span class="m-2">Ch04.</span> <a href="${pageContext.request.contextPath}/ch04/content" class="text-white">
	...
	<li class="nav-item mb-2">
		<h6 class="text-white">
			<span class="m-2">Ch07.</span> <a href="${pageContext.request.contextPath}/ch07/content" class="text-white">
	...
	<li class="nav-item mb-2">
		<h6 class="text-white">
			<span class="m-2">Ch08.</span> <a href="${pageContext.request.contextPath}/ch08/content" class="text-white">
	...
	<li class="nav-item mb-2">
		<h6 class="text-white">
			<span class="m-2">Ch16.</span> <a href="${pageContext.request.contextPath}/ch16/content" class="text-white">
					Transaction
			</a>
		</h6>
	</li>
