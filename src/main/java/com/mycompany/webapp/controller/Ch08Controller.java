...
public class Ch08Controller {
	...
	@GetMapping(value="/saveData",produces = "application/json; chatset=UTF-8")
	@ResponseBody
	...
	@GetMapping(value="/readData",produces = "application/json; chatset=UTF-8")
	@ResponseBody
	...
	@GetMapping("/userinfo")
	public String userinfo(@SessionAttribute String sessionMid, 
